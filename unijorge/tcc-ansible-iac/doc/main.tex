...
\begin{table}[H]
  ...
  \begin{tabular}{lllll}
    ...
    \midrule
    ansible-controller & Controlador Ansible & 1 vCPU & 1,9 GiB & 192.0.2.1  \\
    web01              & Nó gerenciado       & 1 vCPU & 1,9 GiB & 192.0.2.10 \\
    web02              & Nó gerenciado       & 1 vCPU & 1,9 GiB & 192.0.2.11 \\
    \bottomrule
  \end{tabular}
  \fonte{elaborado pelo autor (2026)}
\end{table}
...
[webservers]
web01  ansible_host=192.0.2.10  ansible_user=user
       ansible_ssh_private_key_file=~/.ssh/id_ed25519
web02  ansible_host=192.0.2.11  ansible_user=user
       ansible_ssh_private_key_file=~/.ssh/id_ed25519
