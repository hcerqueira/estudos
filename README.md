...
### IFBA — Curso Técnico em Informática
| Pasta | Conteúdo |
|---|---|
| `ifba/agenda-academica` | Sistema web de agenda acadêmica (JSP/Java) |
| `ifba/c` | Exercícios de lógica de programação (C#) |
| `ifba/codigosBasicosJava` | Primeiros exercícios em Java |
| `ifba/uri-problemas` | Soluções de problemas do URI Online Judge |
| `ifba/html`, `ifba/java` | Exercícios introdutórios |

### UNEB — Bacharelado em Sistemas de Informação
| Pasta | Conteúdo |
|---|---|
| `uneb/EstudosOO` | Exercícios de Programação Orientada a Objetos (roteiros de avaliação) |
| `uneb/EstudosREDES` | Fundamentos de redes — servidor web simples em Java |
| `uneb/TAD_Estrutura-de-dados_II` | Estruturas de dados — implementação de grafos |
| `uneb/supermercado` | Projeto acadêmico maior: e-commerce em PHP (MVC, autenticação, carrinho) |
| `uneb/Livraria` | Página estática de loja de livros (HTML/CSS) |
| `uneb/Web` | Exercícios do curso de fundamentos web moderno (JS, DOM, CSS, Node, React, Vue) |
| `uneb/python` | Exercícios introdutórios em Python |
| `uneb/sql` | Prática de queries SQL |
| `uneb/others/crud-livros` | CRUD simples de livros |
